package com.remmelt.kafka_j.consumer.simple;
...
public class SimpleExample {
	...
	private String findNewLeader(String a_oldLeader, String a_topic, int a_partition, int a_port) throws Exception {
		for (int i = 0; i < 3; i++) {
			...
			if (metadata != null) {
				if (metadata.leader() != null) {
					if (!a_oldLeader.equalsIgnoreCase(metadata.leader().host()) || i != 0) {
		...
		log.warn("Unable to find new leader after Broker failure. Exiting");
